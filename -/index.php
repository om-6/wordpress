...
?>
      ...
      <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
          ...
          <div class="container">
            ...
            <a href="#" class="btn btn-outline-secondary mt-3">تابعني على فيسبوك</a>
          </div>
      </div>
        ...
        <div class="position-relative">
            ...
            <form action="" method="POST">
                ...
                <div class="my-2">
                    ...
                    <span style="font-size:15px">ذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص العربى، حيث يمكنك أن تولد مثل هذا النص أو العديد من النصوص الأخرى.</span>
                </div>
